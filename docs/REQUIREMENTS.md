...
| 5.7 | Once all 3 rubbers are in, either captain can still edit for 7 days, then admin-only | ✅ | `EDIT_WINDOW_DAYS`, `locked_at` stamped on all 3 rubbers together |
